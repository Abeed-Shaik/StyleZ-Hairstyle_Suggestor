...
import com.abeed.stylez.databinding.ActivityMeasurementMenBinding
import com.abeed.stylez.databinding.AlertmenmsrmntBinding
import com.abeed.stylez.databinding.AlertwmenmsrmntBinding

class MeasurementMen : AppCompatActivity() {
    private lateinit var binding : ActivityMeasurementMenBinding

    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.men_tip, menu)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        val id = item.itemId
        if (id == R.id.tipmen) {
            startActivity(Intent(this@MeasurementMen, MeasurementTip::class.java))
            return true
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMeasurementMenBinding.inflate(layoutInflater)
        ...
        binding.button2.setOnClickListener {
            ...
            val jl: Float = jls.toFloat()
                ...
                if ((cb<(fl+2)&&cb>(fl-2))&&(fh<(jl+2)&&fh>(jl-2))&&(cb>fh)&&(cb>fh)&&(cb>jl)&&(fl>fh)&&(fl>jl)){
                    ...
                    startActivity(Intent(this, RoundMen::class.java))

                } else if ((fl<(cb+2)&&fl>(cb-2))&&(fh<(cb+2)&&fh>(cb-2))&&(jl<(cb+2)&&jl>(cb-2))){

                    startActivity(Intent(this, SquareMen::class.java))

                } else if ((fh<(cb+2)&&fh>(cb-2))&&(jl<(cb+2)&&jl>(cb-2))&&(fl>cb)){

                    startActivity(Intent(this, OblongMen::class.java))

                } else if ((jl>cb)&&(cb>fh)){

                    startActivity(Intent(this, TriangularMen::class.java))

                } else if ((fl>cb)&&(fh>jl)&&(fl>(((3.0/2.0)*(cb))-1))&&(fl<(((3.0/2.0)*(cb))+1))){

                    startActivity(Intent(this, OvalMen::class.java))

                } else if (((fh>cb)||(fh<(cb+2)&&fh>(cb-2)))&&(cb>jl)){

                    startActivity(Intent(this, HeartMen::class.java))

                } else if (fl>cb && cb>fh && fh>jl){

                    startActivity(Intent(this, DiamondMen::class.java))
